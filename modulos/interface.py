...
class Interface:
    ...
    def tela_login(self):
        layout = [[sg.Text(s=(15, 0), text="Login", text_color="#000000", background_color="#ffffff"),
                   sg.Input(s=(40, 0), key='matricula', default_text="")],
                  [sg.Text(s=(15, 0), text="Senha", text_color="#000000", background_color="#ffffff"),
                   sg.Input(s=(40, 0), key='senha', password_char='*', default_text="")],
                  [sg.Text(s=(15, 0), text="Link", text_color="#000000", background_color="#ffffff"),
                   sg.Input(s=(40, 0), key='link', default_text="https://gmaxweb.ddns.net:8443/Pages/PageLogin.aspx?&url=L1BhZ2VzL1BhZ2VHTWF4V2ViLmFzcHg==")],
